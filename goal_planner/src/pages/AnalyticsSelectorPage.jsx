...
const AnalyticsSelectorPage = () => {
  ...
  const handleViewAnalytics = () => {
    if (selectedGoalId) {
      navigate(`/analytics/${selectedGoalId}`);
    }
  };
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '2rem' }}>
          <div style={{
            ...
            <p style={{ fontSize: '14px', color: 'var(--color-text-secondary)', marginBottom: '2rem' }}>
              Create a goal first to view analytics
            </p>
            <button
    ...
    <div style={{ minHeight: '100vh', backgroundColor: 'var(--color-background-tertiary)' }}>
      ...
      <div style={{ backgroundColor: 'var(--color-background-primary)', borderBottom: '0.5px solid var(--color-border-tertiary)', padding: '1rem 2rem' }}>
        ...
        <p style={{ fontSize: '14px', color: 'var(--color-text-secondary)', margin: '0.5rem 0 0' }}>
          Select a goal to view its analytics
        </p>
      </div>
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '2rem' }}>
            ...
            {goals.map((goal) => (
              <div
                ...
                style={{
                  ...
                  boxShadow: selectedGoalId === goal.id ? '0 1px 2px  rgba(0, 0, 0, 0.1)' : 'none',
                }}
                onMouseEnter={(e) => {
              ...
              >
                <div style={{
                  fontSize: '16px',
                  fontWeight: '600',
                  color: selectedGoalId === goal.id ? 'white' : 'var(--color-text-primary)',
        ...
        <div style={{
          ...
          <h3 style={{ fontSize: '14px', fontWeight: '600', margin: '0 0 1rem', color: 'var(--color-text-primary)' }}>
            📊 What you'll see in Analytics:
          </h3>
          <ul style={{ fontSize: '13px', color: 'var(--color-text-secondary)', margin: 0, paddingLeft: '1.5rem', lineHeight: '1.8' }}>
            <li>Study hours over time (Line chart)</li>
            <li>Confidence by topic (Bar chart)</li>
            <li>Task completion progress (Pie chart)</li>
            <li>Summary statistics (Hours, sessions, pomodoros)</li>
          </ul>
        </div>
      </div>
    </div>
...
export default AnalyticsSelectorPage;