...
const ResourcesSelectorPage = () => {
  ...
  const handleSearchResources = () => {
    if (selectedGoalId) {
      navigate(`/search-resources/${selectedGoalId}`);
    }
  };
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '2rem' }}>
          <div style={{
            ...
            <p style={{ fontSize: '14px', color: 'var(--color-text-secondary)', marginBottom: '2rem' }}>
              Create a goal first to find resources
            </p>
            <button
    ...
    <div style={{ minHeight: '100vh', backgroundColor: 'var(--color-background-tertiary)' }}>
      <div style={{ backgroundColor: 'var(--color-background-primary)', borderBottom: '0.5px solid var(--color-border-tertiary)', padding: '1rem 2rem' }}>
        ...
        <p style={{ fontSize: '14px', color: 'var(--color-text-secondary)', margin: '0.5rem 0 0' }}>
          Select a goal to find and save learning resources
        </p>
      </div>
            ...
            {goals.map((goal) => (
              <div
                ...
                style={{
                  ...
                  boxShadow: selectedGoalId === goal.id ? '0 4px 12px rgba(245, 158, 11, 0.3)' : 'none',
                }}
                onMouseEnter={(e) => {
...
export default ResourcesSelectorPage;