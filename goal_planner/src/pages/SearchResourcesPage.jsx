...
const SearchResourcesPage = () => {
  ...
  const handleSearch = async (e) => {
    ...
    try {
      ...
      const errorMsg = err.response?.data?.error || 'Failed to search videos. Please try again.';
      setError(errorMsg);
      setHasSearched(true);
    } finally {
      setLoading(false);
 ...
 const handleSaveResource = async (video) => {
    ...
    <div style={{ minHeight: '100vh', backgroundColor: 'var(--color-background-tertiary)' }}>
      ...
      <div style={{ backgroundColor: 'var(--color-background-primary)', borderBottom: '0.5px solid var(--color-border-tertiary)', padding: '1rem 2rem' }}>
        ...
        <p style={{ fontSize: '14px', color: 'var(--color-text-secondary)', margin: '0.5rem 0 0' }}>
          {goal?.name} - Find and save YouTube videos
        </p>
      </div>
      ...
      <div style={{ maxWidth: '1000px', margin: '0 auto', padding: '2rem' }}>
        ...
        <form onSubmit={handleSearch} style={{
          ...
          <input
            ...
            placeholder="e.g., 'Graph algorithms tutorial', 'Binary search explained'"
            style={{
              flex: 1,
              padding: '0.75rem',
              border: '0.5px solid var(--color-border-tertiary)',
                ...
                >
                  ...
                  <div style={{ padding: '1rem' }}>
                    ...
                    <div style={{ display: 'flex', gap: '0.75rem' }}>
                      ...
                      <button
                        onClick={() => handleSaveResource(video)}
        ...
        {!hasSearched && (
          <div style={{
            ...
            <p style={{ fontSize: '13px', color: 'var(--color-text-secondary)', margin: '0.5rem 0 0' }}>
              Find YouTube videos related to your goal topics
            </p>
          </div>
        )}
...
export default SearchResourcesPage;